<template>
    ...
    <card url="https://media.istockphoto.com/photos/barbecue-grilled-hot-dog-with-yellow-mustard-on-wooden-table-picture-id923577738?k=20&m=923577738&s=612x612&w=0&h=iM6xQIGI0rnxfF6v3BCja10GGNbhOG8O9ok_tRE6Zh8=" nombre="Hotdog" nombre1="Hot dog con cebolla, jitomate, chile, Papas a la francesa y refresco Coca-Cola original 355ml." />
    <card url="https://media.istockphoto.com/photos/french-fries-and-ketchup-picture-id518207210?k=20&m=518207210&s=612x612&w=0&h=i5EjPe1ikQuCvLQW7jhY945rqDEEhvC3MCE2vUd2XfU=" nombre="Papas a la francesa" nombre1="Papas Con Queso Y Tocino"/>
